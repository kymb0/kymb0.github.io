---
layout: single
title: "LLM Security Part 2: The Anatomy of LLM Defences and How to Defeat Them"
excerpt: "While testing an inordinate amount of flashy new chatbots, I realised I needed to see what was happening INSIDE the defence stack when my payloads were being evaluated"
date: 2026-03-23
header:
  thumb: assets/images/llm-pt2/have_at_thee.jpg
  teaser: assets/images/llm-pt2/have_at_thee.jpg
...
The autopsy window showing the **semantic similarity score** is visible in each screenshot - presenting how close each message landed to the defence threshold. This is measured through computing the cosine similarity between the user's message and a corpus of known attack phrases - the score is how close the message lands to that corpus.
...
![Have At Thee](/assets/images/llm-pt2/have_at_thee.jpg)
...
CAST will be released soon at [github.com/kymb0/CAST](https://github.com/kymb0/CAST/). Make sure to give it a ⭐
