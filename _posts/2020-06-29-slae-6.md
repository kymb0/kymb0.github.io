...
In laymens terms, this essentially means we will rewrite the assembly code to perform the same function, but with as many different ways of doing so as possible.
...
The last shellcat will invoke execve once more, this time to cat the contents of etc/passwd.
