...
...I have close to 10 years under my belt - which may SEEM like a lot, however most of the time was spent on Helpdesk, incident management and pressing buttons in a sequence to patch large scale environments. Only 3 of those years were spent accumulating hard technical skills, when I landed what I would actually call my first __real__ job in IT as a Network Technician. This job, after 7 years finally ignited my passion for tech, up until then it was "just a job" and I was always looking for something better. (Thank you Michael AKA BIG MICK)
...
Although this guy did not get me my first job in Sec __directly__ and would not have had a chance to work for the company I am at now (OMMGGG DON'T LOOK IT UP) if it wasn't for this guy.
